...
system_message = SystemMessage("""
    ...
    for something, fist look if you have a tool that solves that problem.""")

human_message = HumanMessage(
    "Oi, sou o Andrey, pode me falar quanto e 23045.43 vezes 0.54"
)
# human_message = HumanMessage("Oi sou o Andrey")
